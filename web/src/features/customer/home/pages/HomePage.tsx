import { branchesApi, servicesApi } from '@/services/api';
          ...
          {activeServices.map((service) => (
            <Card key={service.id} className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="h-48 overflow-hidden">
                <CoverImage src={service.image_url} alt={service.title} className="h-48 hover:scale-105 transition-transform duration-500" />
              </div>
            ...
            {activeBranches.map((b) => (
              <Card key={b.id} className="overflow-hidden hover:shadow-md transition-shadow">
                <div className="h-36 overflow-hidden">
                  <CoverImage src={b.image_url} alt={b.name} fallback="branch" className="h-36" />
                </div>
