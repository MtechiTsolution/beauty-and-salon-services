...
export function LandingHeroCarousel({ locationLabel }: LandingHeroCarouselProps) {
  ...
  return (
    <section className="landing-hero relative flex flex-col overflow-hidden md:min-h-[100svh] md:min-h-[100dvh]">
      ...
      {/* Fixed hero content */}
      <div className="landing-hero-body relative z-10 mx-auto flex w-full max-w-7xl flex-1 flex-col items-center justify-center px-4 pb-10 pt-24 text-center sm:px-6 sm:pb-10 sm:pt-28 lg:pt-32 max-md:flex-none max-md:justify-start max-md:pb-5 max-md:pt-20">
